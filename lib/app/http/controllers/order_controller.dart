import 'package:tugas_api_paml/app/models/order.dart';
import 'package:tugas_api_paml/app/models/order_item.dart';
import 'package:tugas_api_paml/app/models/product.dart';
...
class OrderController extends Controller {
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      var orderDate = request.input('date');
